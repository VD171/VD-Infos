...
* **Dreamland Manager:** Installer and manager of the Dreamland framework.  
...
* **Android-XML-Converter:** Standalone abx2xml and xml2abx. An experimental code to convert between android xml formats (abx and xml).  
...
* **Guide HMA:** A quick guide to hopefully make it a little easier for people new to Hide My Applist.  
https://github.com/mModule/guide_hma  
* **Guide for Hide My Applist:** A guide for Hide My Applist.  
...
* (Deprecated) **Kitsune Mask (Magisk Delta):** A fork of Magisk.  
